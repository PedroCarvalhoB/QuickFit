<div id="main" class="container-fluid">
    ...
    <form action="?page=insere_cad" method="post">
        <!-- 1ª LINHA -->
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="radio" name="sexo_usu" id="sexo" value="M">Masculino
                &nbsp; &nbsp;
                <input type="radio" name="sexo_usu" id="sexo" value="F">Feminino
            </div>
        </div>
        <!-- 3ª LINHA -->
        <div class="row">
