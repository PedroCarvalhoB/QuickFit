...
if (isset($_GET['page'])) {
    ...
    switch ($_GET['page']) {
        ...
        case 'block_acad':
            include "content/admin/crud/block_acad.php";
            break;

        case 'ativa_acad':
            include "content/admin/crud/ativa_acad.php";
            break;
        ...
        case 'view_gerente':
            include "content/gerente/crud/view_gerente.php";    
            break;

        case 'fedita_gerente':
            include "content/gerente/crud/fedita_gerente.php";
            break;
            
        case 'atualiza_gerente':
