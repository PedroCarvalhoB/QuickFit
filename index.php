...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="index.html" class="logo">Quick<em> Fit</em></a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                    ...
                    <ul class="features-items">
                        <li class="feature-item">
                            ...
                            <div class="left-content">
                                <h4>Fichas Eletrônicas</h4>
                                <p>Nosso sistema para academias é a solução perfeita para quem busca otimizar processos e atender melhor seus alunos. Com ele, é possível criar séries de exercícios personalizadas de forma rápida e fácil. Com nosso sistema, você terá acesso a uma vasta biblioteca de exercícios, o que possibilita a criação de treinos personalizados de acordo com as necessidades e objetivos de cada aluno.</p>
                            </div>
                        </li>
                        <li class="feature-item">
                            <div class="left-icon">
                            ...
                            <div class="left-content">
                                ...
                                <p>Nosso sistema de cadastro de exercícios para academias foi desenvolvido para tornar o gerenciamento de treinos mais fácil e eficiente. Com ele, é possível cadastrar todos os exercícios utilizados pela academia e organizá-los de forma prática e intuitiva. Cada exercício é cadastrado com suas informações completas, incluindo nome, descrição, músculos trabalhados.</p>
                            </div>
                        </li>
                        <li class="feature-item">
                            <div class="left-icon">
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright &copy; 2020 QuickFit</p>
                </div>
            </div>
        </div>
    </footer>
