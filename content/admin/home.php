        ...
        <div id="main" class="container-fluid">
            ...
            <div id="bloco-list-pag">
                ...
                ORDER BY id_acad ";
                        ...
                        echo "<li class='page-item'><a class='page-link' href='?page=home_adm&pagina=1'> Primeira</a></li> ";
                        echo "<li class='page-item'><a class='page-link' href=\"?page=home_adm&pagina=$anterior\"> Anterior</a></li> ";

                        echo "<li class='page-item'><a class='page-link' href='?page=home_adm&pagina=" . $pagina . "'><strong>" . $pagina . "</strong></a></li> ";

                        for ($i = $pagina + 1; $i < $pagina + $exibir; $i++) {
                            if ($i <= $totalpagina)
                                echo "<li class='page-item'><a class='page-link' href='?page=home_adm&pagina=" . $i . "'> " . $i . " </a></li> ";
                        }

                        echo "<li class='page-item'><a class='page-link' href=\"?page=home_adm&pagina=$posterior\"> Pr&oacute;xima</a></li> ";
                        echo "<li class='page-item'><a class='page-link' href=\"?page=home_adm&pagina=$totalpagina\"> &Uacute;ltima</a></li></ul>";
