...
<body>
	<main>
		...
		<div id="main" class="container-fluid">
			...
			<h3 class="page-header">Editar registro do Gerente - <?php echo $id; ?></h3>

			<br>

			<!-- Área de campos do formulário de edição-->

			<form action="?page=atualiza_gerente&id_usu=<?php echo $row['id_usu']; ?>" method="post">
				...
				<div id="actions" class="row botoes">
					<div class="col-md-12">
						<a href="?page=view_gerente" class="btncancel">Voltar</a>
