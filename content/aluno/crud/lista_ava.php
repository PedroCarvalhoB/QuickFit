	...
	<div id="bloco-list-pag">
		<div id="list" class="row">
			<div class="table-responsive col-xs-12">
                ...
                WHERE id_alu = $id limit $inicio, $quantidade;";
				...
				echo "<td><strong>Objetivo</strong></td>";
		...
		<div id="bottom" class="row">
			<div class="col-md-12">
				...
				echo "<li class='page-item'><a class='page-link' href='?page=aluno_ava&pagina=1'> Primeira</a></li> ";
				echo "<li class='page-item'><a class='page-link' href=\"?page=aluno_ava&pagina=$anterior\"> Anterior</a></li> ";

				echo "<li class='page-item'><a class='page-link' href='?page=aluno_ava&pagina=" . $pagina . "'><strong>" . $pagina . "</strong></a></li> ";

				for ($i = $pagina + 1; $i < $pagina + $exibir; $i++) {
					if ($i <= $totalpagina)
						echo "<li class='page-item'><a class='page-link' href='?page=aluno_ava&pagina=" . $i . "'> " . $i . " </a></li> ";
				}

				echo "<li class='page-item'><a class='page-link' href=\"?page=aluno_ava&pagina=$posterior\"> Pr&oacute;xima</a></li> ";
				echo "<li class='page-item'><a class='page-link' href=\"?page=aluno_ava&pagina=$totalpagina\"> &Uacute;ltima</a></li></ul>";
