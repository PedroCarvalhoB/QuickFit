                ...
                <div id="bloco-list-pag">
                    ...
                    <div id="bottom" class="row">
                        <div class="col-md-12">
                            ...
                            echo "<li class='page-item'><a class='page-link' href='?page=home_prof&pagina=1'> Primeira</a></li> ";
                            echo "<li class='page-item'><a class='page-link' href=\"?page=home_prof&pagina=$anterior\"> Anterior</a></li> ";

                            echo "<li class='page-item'><a class='page-link' href='?page=home_prof&pagina=" . $pagina . "'><strong>" . $pagina . "</strong></a></li> ";

                            for ($i = $pagina + 1; $i < $pagina + $exibir; $i++) {
                                if ($i <= $totalpagina)
                                    echo "<li class='page-item'><a class='page-link' href='?page=home_prof&pagina=" . $i . "'> " . $i . " </a></li> ";
                            }

                            echo "<li class='page-item'><a class='page-link' href=\"?page=home_prof&pagina=$posterior\"> Pr&oacute;xima</a></li> ";
                            echo "<li class='page-item'><a class='page-link' href=\"?page=home_prof&pagina=$totalpagina\"> &Uacute;ltima</a></li></ul>";
