            ...
            <form action="?page=insere_ava" method="post">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" class="form-control" name="altura" step="any" required placeholder="Centímetros">
                    </div>
                    <div class="form-group col-md-3">
                ...
                <div class="row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" class="form-control" name="cinrcun_abdom" required placeholder="Centímetros">
                    </div>
                    <div class="form-group col-md-3">
